  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>iindex.php/simpanankhususcon/create_simpanankhusus"><i class="fa fa-table"></i>Simpanan Khusus</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
	     <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            ...
            <form action="<?php echo base_url();?>index.php/simpanankhususcon/insert_simpanankhusus" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
