            ...
            <form action="<?php echo base_url();?>index.php/simpanan3thmastercon/insert_simpanan3thmaster" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                <div class="form-group col-xs-12">
                  ...
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Misal: Simpanan 3 Th Ke 20">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet Penerimaan Simpanan</label>
                  <input class="form-control" id="kode_debet_penerimaan_simp" name="kode_debet_penerimaan_simp">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit Penerimaan Simpanan</label>
                  <input class="form-control" id="kode_kredit_penerimaan_simp" name="kode_kredit_penerimaan_simp">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet Pencairan Simpanan</label>
                  <input class="form-control" id="kode_debet_pencairan_simp" name="kode_debet_pencairan_simp">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit Pencairan Simpanan</label>
                  <input class="form-control" id="kode_kredit_pencairan_simp" name="kode_kredit_pencairan_simp">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet Pencairan Hutang Jasa</label>
                  <input class="form-control" id="kode_debet_pencairan_hutang_jasa" name="kode_debet_pencairan_hutang_jasa">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit Pencairan Hutang Jasa</label>
                  <input class="form-control" id="kode_kredit_pencairan_hutang_jasa" name="kode_kredit_pencairan_hutang_jasa">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet Pembayaran Jasa</label>
                  <input class="form-control" id="kode_debet_pembayaran_jasa" name="kode_debet_pembayaran_jasa">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit Pembayaran Jasa</label>
                  <input class="form-control" id="kode_kredit_pembayaran_jasa" name="kode_kredit_pembayaran_jasa">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet Penyesuaian Jasa</label>
                  <input class="form-control" id="kode_debet_penyesuaian_jasa" name="kode_debet_penyesuaian_jasa">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit Penyesuaian Jasa</label>
                  <input class="form-control" id="kode_kredit_penyesuaian_jasa" name="kode_kredit_penyesuaian_jasa">
                </div>
              </div>
              <!-- /.box-body -->
