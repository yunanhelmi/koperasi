  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/pinjamancon/create_pinjaman"><i class="fa fa-table"></i>Pinjaman Baru</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
	     <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            ...
            <form action="<?php echo base_url();?>index.php/pinjamancon/insert_pinjaman" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
