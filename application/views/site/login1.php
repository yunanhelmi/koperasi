        ...
        <div class="container">
            <div class="row">
                ...
                <div class="one-third column" style="margin-top: 1%">
					...
					<form action="<?php echo base_url(); ?>index.php/usercon/veriflogin" method="post">
						<div style="padding-bottom: 5px">
							<input class="u-full-width" type="text" placeholder="Username" id="username" name="username" tabindex="1" required>
						</div>
						<div style="padding-bottom: 5px">
							<input class="u-full-width" type="password" placeholder="Password" id="password" name="password" tabindex="2" required>
						</div>
						<input name="login" class="u-full-width button-primary" type="submit" value="login">
					</form>
					<a href="<?php echo base_url()?>index.php/usercon/register1" class="text-center">Register</a>
