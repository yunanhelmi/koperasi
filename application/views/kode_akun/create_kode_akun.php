  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/kodeakuncon/create_kode_akun"><i class="fa fa-table"></i>Kode Akun Baru</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
       <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            <legend style="text-align:center;">KODE AKUN BARU</legend>
            <form action="<?php echo base_url();?>index.php/kodeakuncon/insert_kode_akun" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
