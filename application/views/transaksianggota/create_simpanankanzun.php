        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_kanzun">
              ...
              <legend style="text-align:center;">SIMPANAN KANZUN BARU</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/insert_simpanankanzun/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
