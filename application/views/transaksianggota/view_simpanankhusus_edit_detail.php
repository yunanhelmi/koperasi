...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()."index.php/transaksianggotacon/simpanankhusus/".$nasabah->id; ?>" ><i class="fa fa-credit-card"></i> Simpanan Khusus</a></li>
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_khusus">
              ...
              <div class="row">
                <div class="col-md-12 pull-left">
                  <div class="box box-danger" id="div_tambah_detail_simpanankhusus" style="display:none">
                    ...
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/insert_detail_simpanankhusus" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                      ...
                      <div class="box-footer">
                        ...
                        <div class="col-xs-3">
                          <button type="button" onclick="cancelTambahDetailSimpananKhusus()" class="btn btn-warning">Batal</button>
                        </div>
                      </div>
                    </form>
                  </div>
                  <div class="box box-danger" id="div_edit_detail_simpanankhusus">
                    ...
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/update_detail_simpanankhusus" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Tanggal</label>
                          <div class="input-group date">
                        ...
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Bulan-Tahun</label>
                          <input type="month" class="form-control" value="<?php echo $edit_detail_simpanankhusus->bulan_tahun?>" id="edit_bulan_tahun" name="edit_bulan_tahun" placeholder="">
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Jumlah</label>
                          <div class="input-group margin-bottom-sm">
  ...
  <script>
    ...
    function getConfirmationDDeleteDetailSimpanankhusus(id_simpanankhusus, id_detail_simpanankhusus){
    ...
    function cancelTambahDetailSimpananKhusus() {
      document.getElementById("div_tambah_detail_simpanankhusus").style.display = "none"; 
    }
