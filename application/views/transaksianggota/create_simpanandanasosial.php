        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_dana_sosial">
              ...
              <legend style="text-align:center;">SIMPANAN DANA SOSIAL BARU</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/insert_simpanandanasosial/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
