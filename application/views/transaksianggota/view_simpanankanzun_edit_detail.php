...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()."index.php/transaksianggotacon/simpanankanzun/".$nasabah->id; ?>" ><i class="fa fa-credit-card"></i> Simpanan Kanzun</a></li>
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            ?>
            <li class="active"><a href="#simpanan_kanzun" data-toggle="tab">Simpanan Kanzun</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_kanzun">
              ...
              <div class="row">
                <div class="col-md-12 pull-left">
                  <div class="box box-danger" id="div_tambah_detail_simpanankanzun" style="display:none">
                    ...
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/insert_detail_simpanankanzun" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                      ...
                      <div class="box-footer">
                        ...
                        <div class="col-xs-3">
                          <button type="button" onclick="cancelTambahDetailSimpananKanzun()" class="btn btn-warning">Batal</button>
                        </div>
                      </div>
                    </form>
                  </div>
                  <div class="box box-danger" id="div_edit_detail_simpanankanzun">
                    <legend style="text-align:center;">EDIT DETAIL SIMPANAN KANZUN</legend>
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/update_detail_simpanankanzun" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Tanggal</label>
                          <div class="input-group date">
                            ...
                            <?php 
                              $tgl = strtotime($edit_detail_simpanankanzun->waktu);
                            ?>
                            ...
                            <input type="hidden" class="form-control" value="<?php echo $edit_detail_simpanankanzun->id?>" id="edit_id" name="edit_id">
                            <input type="hidden" class="form-control" value="<?php echo $edit_detail_simpanankanzun->id_simpanankanzun?>" id="edit_id_simpanankanzun" name="edit_id_simpanankanzun">
                          </div>
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Jenis</label>
                          <select id="edit_jenis" name="edit_jenis" class="form-control" style="width: 100%;">
                            <option value='Setoran' <?php echo $edit_detail_simpanankanzun->jenis == 'Setoran' ? 'selected' : ''?> >Setoran</option>
                            <option value='Tarikan' <?php echo $edit_detail_simpanankanzun->jenis == 'Tarikan' ? 'selected' : ''?> >Tarikan</option>
                          </select>
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Bulan-Tahun</label>
                          <input type="month" class="form-control" value="<?php echo $edit_detail_simpanankanzun->bulan_tahun?>" id="edit_bulan_tahun" name="edit_bulan_tahun" placeholder="">
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Jumlah</label>
                          <div class="input-group margin-bottom-sm">
                            <span class="input-group-addon">Rp</span>
                            <input type="text" class="form-control" value="<?php echo $edit_detail_simpanankanzun->jumlah?>" id="edit_jumlah" name="edit_jumlah" placeholder="0">
                          </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <?php 
                              ...
                              $bln_thn = strtotime( $detail_simpanankanzun[$i]['bulan_tahun'] );
  ...
  <script>
    ...
    function getConfirmationDeleteDetailSimpanankanzun(id_simpanankanzun, id_detail_simpanankanzun){
    ...
    function tambahDetailSimpananKanzun() {
      document.getElementById("div_edit_detail_simpanankanzun").style.display = "none";
      document.getElementById("div_tambah_detail_simpanankanzun").style.display = "block";
    }

    function cancelTambahDetailSimpananKanzun() {
      document.getElementById("div_tambah_detail_simpanankanzun").style.display = "none"; 
    }
