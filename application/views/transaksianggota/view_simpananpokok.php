                ...
                <table id="simpanankhusus_table" class="table table-bordered table-hover"  width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <td style='text-align: center'><a class="btn btn-primary" href="<?php echo site_url("transaksianggotacon/simpanankhusus_unpost_akuntansi/".$simpanankhusus->id); ?>"><i class="fa fa-times"></i></a></td>
                      <?php
                      } else {
                      ?>
                      ...
                      <td style='text-align: center'><a class="btn btn-primary" href="<?php echo site_url("transaksianggotacon/simpanankhusus_post_akuntansi/".$simpanankhusus->id); ?>"><i class="fa fa-upload"></i></a></td>
                      <?php
                      }
                      ?>
                    </tr>
