        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_khusus">
              ...
              <legend style="text-align:center;">SIMPANAN KHUSUS BARU</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/insert_simpanankhusus/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
