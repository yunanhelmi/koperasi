        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="berkas">
              <legend style="text-align:center;">EDIT SCAN BERKAS</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/update_berkas/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                  <div class="form-group col-xs-6">
                    <label for="exampleInputEmail1">Nama Berkas</label>
                    <input type="text" class="form-control" id="nama_berkas" name="nama_berkas" placeholder="Nama Berkas" value="<?php echo $berkas->nama_berkas;?>" required>
                    <input type="hidden" class="form-control" value="<?php echo $berkas->id?>" id="id" name="id">
                    <input type="hidden" class="form-control" id="id_nasabah" name="id_nasabah" value="<?php echo $berkas->id_nasabah;?>">
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputFile">Upload File</label>
                    <input type="file" accept=".jpg, .jpeg" name="file_berkas">
                  </div>
                </div>
                <div class="box-footer">
                  ...
                  <div class="col-xs-3">
                    <a class="btn btn-primary btn-warning" href="<?php echo site_url("transaksianggotacon/berkas/".$nasabah->id); ?>">Batal</a>
                  </div>
                </div>
              </form>
            </div>
