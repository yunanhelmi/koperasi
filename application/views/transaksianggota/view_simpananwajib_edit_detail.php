...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()."index.php/transaksianggotacon/simpananwajib/".$nasabah->id; ?>" ><i class="fa fa-credit-card"></i> Simpanan Wajib</a></li>
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            ?>       
            <li class="active"><a href="#simpanan_wajib" data-toggle="tab">Simpanan Wajib</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_wajib">
              ...
              <div class="row">
                <div class="col-md-12 pull-left">
                  <div class="box box-danger" id="div_tambah_detail_simpananwajib" style="display:none">
                    ...
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/insert_detail_simpananwajib" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                        ...
                        <div class="box-footer">
                          ...
                          <div class="col-xs-3">
                            <button type="button" onclick="cancelTambahDetailSimpananWajib()" class="btn btn-warning">Batal</button>
                          </div>
                        </div>
                      </form>
                    </div>
                  <div class="box box-danger" id="div_edit_detail_simpananwajib">
                    <legend style="text-align:center;">EDIT DETAIL SIMPANAN WAJIB</legend>
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/update_detail_simpananwajib" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Tanggal</label>
                          <div class="input-group date">
                            ...
                            <?php 
                              $tgl = strtotime($edit_detail_simpananwajib->waktu);
                            ?>
                            ...
                            <input type="hidden" class="form-control" value="<?php echo $edit_detail_simpananwajib->id?>" id="edit_id" name="edit_id">
                            <input type="hidden" class="form-control" value="<?php echo $edit_detail_simpananwajib->id_simpananwajib?>" id="edit_id_simpananwajib" name="edit_id_simpananwajib">
                          </div>
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Jenis</label>
                          <select id="edit_jenis" name="edit_jenis" class="form-control" style="width: 100%;">
                            <option value='Setoran' <?php echo $edit_detail_simpananwajib->jenis == 'Setoran' ? 'selected' : ''?> >Setoran</option>
                            <option value='Tarikan' <?php echo $edit_detail_simpananwajib->jenis == 'Tarikan' ? 'selected' : ''?> >Tarikan</option>
                          </select>
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Bulan-Tahun</label>
                          <input type="month" class="form-control" value="<?php echo $edit_detail_simpananwajib->bulan_tahun?>" id="edit_bulan_tahun" name="edit_bulan_tahun" placeholder="">
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Jumlah</label>
                          <div class="input-group margin-bottom-sm">
                            <span class="input-group-addon">Rp</span>
                            <input type="text" class="form-control" value="<?php echo $edit_detail_simpananwajib->jumlah?>" id="edit_jumlah" name="edit_jumlah" placeholder="0">
                          </div>
                        ...
                        <table id="detail_simpananwajib_table" class="table table-bordered table-hover"  width="100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <?php 
                              if($detail_simpananwajib[$i]['status_post'] == 1) {
                              ?>
                              <td></td>
                              <td></td>
                              <td style='text-align: center'><a class="btn btn-primary" href="<?php echo site_url("transaksianggotacon/simpananwajib_unpost_akuntansi/".$simpananwajib->id."/".$detail_simpananwajib[$i]['id']); ?>"><i class="fa fa-times"></i></a></td>
                              <?php
                              } else {
                              ?>
                              ...
                              <td style='text-align: center'><a class="btn btn-danger" onClick="getConfirmationDDeleteDetailSimpananwajib('<?php echo $simpananwajib->id?>','<?php echo $detail_simpananwajib[$i]['id']?>');"><i class="fa fa-trash-o"></i></a></td>
                              <td style='text-align: center'><a class="btn btn-primary" href="<?php echo site_url("transaksianggotacon/simpananwajib_post_akuntansi/".$simpananwajib->id."/".$detail_simpananwajib[$i]['id']); ?>"><i class="fa fa-upload"></i></a></td>
                              <?php
                              }
                              ?>
                            </tr>
  ...
  function getConfirmationDDeleteDetailSimpananwajib(id_simpananwajib, id_detail_simpananwajib){
  ...
  function tambahDetailSimpananWajib() {
    document.getElementById("div_edit_detail_simpananwajib").style.display = "none";
    document.getElementById("div_tambah_detail_simpananwajib").style.display = "block";
  }

  function cancelTambahDetailSimpananWajib() {
      document.getElementById("div_tambah_detail_simpananwajib").style.display = "none";
    }
