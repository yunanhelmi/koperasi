...
<!-- Content Wrapper. Contains page content -->
              ...
              <div class="row">
                <div class="col-md-12 pull-left">
                  <div class="box box-danger" id="div_tambah_detail_simpanandanasosial" style="display:none">
                    ...
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/insert_detail_simpanandanasosial" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                  ...
                  <div class="box box-danger" id="div_edit_detail_simpanandanasosial">
                    ...
                    <form action="<?php echo base_url();?>index.php/transaksianggotacon/update_detail_simpanandanasosial" method="post" enctype="multipart/form-data" role="form">
                      <div class="box-body">
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Tanggal</label>
                          <div class="input-group date">
                        ...
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Bulan-Tahun</label>
                          <input type="month" class="form-control" value="<?php echo $edit_detail_simpanandanasosial->bulan_tahun?>" id="edit_bulan_tahun" name="edit_bulan_tahun" placeholder="">
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="exampleInputPassword1">Jumlah</label>
                          <div class="input-group margin-bottom-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <?php 
                              ...
                              $bln_thn = strtotime( $detail_simpanandanasosial[$i]['bulan_tahun'] );
  ...
  function getConfirmationDDeleteDetailSimpanandanasosial(id_simpanandanasosial, id_detail_simpanandanasosial){
