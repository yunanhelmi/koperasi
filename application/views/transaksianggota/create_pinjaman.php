        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="pinjaman">
              ...
              <form action="<?php echo base_url()."index.php/transaksianggotacon/insert_pinjaman/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                  <div class="form-group col-xs-6">
                    ...
                    <input type="hidden" class="form-control" id="id_nasabah" name="id_nasabah" value="<?php echo $nasabah->id;?>">
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputPassword1">Nomor Anggota</label>
                    <input type="text" class="form-control" id="nomor_nasabah" name="nomor_nasabah" placeholder="Nomor Anggota" value="<?php echo $nasabah->nomor_koperasi;?>" readonly>
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputPassword1">NIK</label>
                    <input type="text" class="form-control" id="nik_nasabah" name="nik_nasabah" placeholder="NIK Anggota" value="<?php echo $nasabah->nik;?>" readonly>
                  </div>
                  <div class="form-group col-xs-6">
                  ...
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group date">
                      ...
                      <?php
                        $today = date("d-m-Y");
                        $jatuh_tempo = date('d-m-Y',strtotime($today." +4 Months"));
                      ?>
                      <input type="text" class="form-control pull-right" name="jatuh_tempo" id="jatuh_tempo" value="<?php echo $jatuh_tempo;?>" data-date-format="dd-mm-yyyy">
                    </div>
                  </div>
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group margin-bottom-sm">
                      ...
                      <input type="text" class="form-control" id="jumlah_pinjaman" name="jumlah_pinjaman" placeholder="Jumlah Pinjaman">
                    </div>
                    <div id="label_jumlah_pinjaman" class="alert-danger"></div> 
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputPassword1">Jumlah Angsuran</label>
                    <input type="text" class="form-control" id="jumlah_angsuran" name="jumlah_angsuran" placeholder="Jumlah Angsuran">
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputPassword1">Angsuran Perbulan</label>
                    <div class="input-group margin-bottom-sm">
                      <span class="input-group-addon">Rp</span>
                      <input type="text" class="form-control" id="angsuran_perbulan" name="angsuran_perbulan" placeholder="0">
                    </div>
                  ...
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group margin-bottom-sm">
                      <span class="input-group-addon">Rp</span>
                      <input type="text" class="form-control" id="jasa_perbulan" name="jasa_perbulan" placeholder="0">
                    </div>
