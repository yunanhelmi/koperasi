        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_wajib">
              ...
              <legend style="text-align:center;">EDIT SIMPANAN WAJIB</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/update_simpananwajib"?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                  <div class="form-group col-xs-6">
                    <label for="exampleInputEmail1">Nama Anggota</label>
                    <input type="text" class="form-control" id="nama_nasabah" name="nama_nasabah" placeholder="Nama Nasabah" value="<?php echo $simpananwajib->nama_nasabah;?>" readonly>
                    <input type="hidden" class="form-control" id="id_nasabah" name="id_nasabah" value="<?php echo $simpananwajib->id_nasabah;?>">
                    <input type="hidden" class="form-control" id="id_simpananwajib" name="id_simpananwajib" value="<?php echo $simpananwajib->id;?>">
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputPassword1">Nomor ANggota</label>
                    <input type="text" class="form-control" id="nomor_nasabah" name="nomor_nasabah" placeholder="Nomor Anggota" value="<?php echo $simpananwajib->nomor_nasabah;?>" readonly>
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputPassword1">NIK</label>
                    <input type="text" class="form-control" id="nik_nasabah" name="nik_nasabah" placeholder="NIK Anggota" value="<?php echo $simpananwajib->nik_nasabah;?>" readonly>
                  </div>
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group date">
                      ...
                      <?php $date = strtotime($simpananwajib->waktu);?>
                  ...
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group margin-bottom-sm">
                      ...
                      <input type="text" class="form-control" value="<?php echo $simpananwajib->total?>" id="total" name="total" placeholder="0" readonly>
                    </div>
