        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="berkas">
              <legend style="text-align:center;">TAMBAH SCAN BERKAS</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/insert_berkas/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                  <div class="form-group col-xs-6">
                    <label for="exampleInputEmail1">Nama Berkas</label>
                    <input type="text" class="form-control" id="nama_berkas" name="nama_berkas" placeholder="Nama Berkas" required>
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="exampleInputFile">Upload File</label>
                    <input type="file" accept=".jpg, .jpeg" name="file_berkas" required>
                  </div>
                </div>
