        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="simpanan_pokok">
              ...
              <form action="<?php echo base_url()."index.php/transaksianggotacon/update_simpananpokok"?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
                  ...
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group margin-bottom-sm">
                      ...
                      <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?php echo $simpananpokok->jumlah;?>" placeholder="0">
                    </div>
