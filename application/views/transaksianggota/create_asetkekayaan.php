        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="active tab-pane" id="aset_kekayaan">
              <legend style="text-align:center;">TAMBAH ASET KEKAYAAN</legend>
              <form action="<?php echo base_url()."index.php/transaksianggotacon/insert_asetkekayaan/".$nasabah->id;?>" method="post" enctype="multipart/form-data" role="form">
                <div class="box-body">
