  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/transaksicon/edit_transaksi"><i class="fa fa-table"></i>Edit Transaksi Lain-Lain Baru</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
       <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            <legend style="text-align:center;">EDIT TRANSAKSI LAIN-LAIN</legend>
            <form action="<?php echo base_url();?>index.php/transaksicon/update_transaksi" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                <div class="form-group col-xs-6">
                  ...
                  <div class="input-group date">
                    ...
                    <?php $date = strtotime($transaksi->tanggal);?>
                ...
                <div class="form-group col-xs-6">
                  ...
                  <input type="text" class="form-control" id="nama_transaksi" name="nama_transaksi" value="<?php echo $transaksi->nama_transaksi?>" placeholder="">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Keterangan</label>
                  <!-- <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?php echo $transaksi->keterangan?>" placeholder=""> -->
                  <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan"><?php echo $transaksi->keterangan?></textarea>
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet</label>
                  <input type="textarea" class="form-control" id="kode_debet" name="kode_debet" value="<?php echo $transaksi->kode_debet?>" placeholder="">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit</label>
                  <input type="textarea" class="form-control" id="kode_kredit" name="kode_kredit" value="<?php echo $transaksi->kode_kredit?>" placeholder="">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Jumlah</label>
                  <div class="input-group margin-bottom-sm">
                    <span class="input-group-addon">Rp</span>
                    <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?php echo $transaksi->jumlah?>" placeholder="0">
                  </div>
