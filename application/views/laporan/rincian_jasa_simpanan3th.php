...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/laporanrincianjasasimpanan3thcon/index"><i class="fa fa-book"></i> Rincian Jasa Simpanan 3 Th</a></li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">LAPORAN RINCIAN JASA SIMPANAN 3 TH</legend>
    				<form action="<?php echo base_url();?>index.php/laporanrincianjasasimpanan3thcon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
