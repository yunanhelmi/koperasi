    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">LAPORAN RINCIAN JASA</legend>
    				<form action="<?php echo base_url();?>index.php/laporanrincianjasacon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
