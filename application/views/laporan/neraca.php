...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/laporanneracacon/index"><i class="fa fa-balance-scale"></i> Neraca</a></li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">LAPORAN NERACA</legend>
    				<form action="<?php echo base_url();?>index.php/laporanneracacon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
...
function view_laporan() {
	...
	if(dari == '' || dari == null ) {
		...
		var controller = 'laporanneracacon';
