...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/laporansimpanandanasosialcon/index"><i class="fa fa-book"></i> Simpanan Dansos Anggota</a></li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">LAPORAN DAFTAR SIMPANAN DANSOS ANGGOTA</legend>
    				<form action="<?php echo base_url();?>index.php/laporansimpanandanasosialcon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
			            ...
			            <div class="box-footer">
							...
							<div class="col-xs-3">
				            	<div class="form-group pull-left">
									<button type="submit" class="btn btn-success" name="excel"><i class="fa fa-eye"></i> Tammpilkan</button>
								</div>
							</div>
						</div>  
					</form>
