...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/laporansimpananpokokistimewacon/index"><i class="fa fa-book"></i> Simpanan Pokok Istimewa</a></li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">LAPORAN DAFTAR SIMPANAN POKOK ISTIMEWA</legend>
    				<form action="<?php echo base_url();?>index.php/laporansimpananpokokistimewacon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
