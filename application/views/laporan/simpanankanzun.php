...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/laporansimpanankanzuncon/index"><i class="fa fa-book"></i> Simpanan Kanzun</a></li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">LAPORAN DAFTAR SIMPANAN KANZUN</legend>
    				<form action="<?php echo base_url();?>index.php/laporansimpanankanzuncon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
