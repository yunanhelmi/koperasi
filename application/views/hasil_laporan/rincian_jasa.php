...
<table border="1" style="width:100%; border-collapse: collapse;">
    ...
    ?>
            <tr>
                ...
                <td style="text-align: right;"><?php echo number_format($jumlah_jasa) ?></td>
            </tr>
    <?php
        $no++;
        }
    ...
    <tr>
        ...
        <td style="text-align: right;"><strong><?php echo number_format($total_jasa) ?></strong></td>
    </tr>
    <tr>
        <td colspan="8" style="text-align: center;"><strong>TOTAL (NERACA)</strong></td>
        <td style="text-align: right;"><strong><?php echo number_format($total_neraca) ?></strong></td>
    </tr>
    <?php
    ...
    <tr>
        ...
        <td style="text-align: right;"><strong><?php echo number_format($transaksi_pendapatan[0]['jumlah_debet']) ?></strong></td>
    </tr>
    <?php
    ...
    <tr>
        <td colspan="8" style="text-align: center;"><strong>SELISIH</strong></td>
        <td style="text-align: right;"><strong><?php echo number_format($selisih_pencairan) ?></strong></td>
    </tr>
</table>