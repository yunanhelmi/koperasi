...
<table class="kop_surat">
    <tr>
        <td colspan="20"><center>KOPERASI KHOZANAH MAMBAUL MUBASYIRIN</center></td>
    </tr>
    <tr>
        <td colspan="20"><center>LAPORAN PIUTANG ANGGOTA <?php echo $tanggal_title ?></center></td>
    </tr>
    <tr>
        <td class="bold" colspan="20"><center>AHU-0003689.AH.01.39.TAHUN 2022</center></td>
    </tr>
    <tr>
        <td colspan="20"><center>Kantor : Desa Ngumpakdalem Rt 10 Rw 03 Kecamatan Dander Kabupaten Bojonegoro</center></td>
    </tr>
</table>
<br>
<?php
	for($a = 0; $a < sizeof($data); $a++) {
		...
		if($data[$a]['jenis_pinjaman'] == 'Angsuran') {
            ...
            if($lama_jatuh_tempo >= -5 && $lama_jatuh_tempo <= 11) {
                $data[$a]['keterangan'] = 'Hijau Tempo';
                $data[$a]['keterangan_level'] = 0;
            } else if($lama_jatuh_tempo > 11 && $lama_jatuh_tempo <= 60) {
                $data[$a]['keterangan'] = 'Kuning 1';
                $data[$a]['keterangan_level'] = 1;
            } else if($lama_jatuh_tempo > 60 && $lama_jatuh_tempo <= 120) {
                $data[$a]['keterangan'] = 'Kuning 2';
                $data[$a]['keterangan_level'] = 2;
            } else if($lama_jatuh_tempo > 120) {
                $data[$a]['keterangan'] = 'Merah';
                $data[$a]['keterangan_level'] = 3;
            }*/
...
<table border="1" style="width:100%; border-collapse: collapse;">
	...
	<?php
	  	...
	  	$total_uang_kurang = 0;
	  	for($a = 0; $a < sizeof($data); $a++) {
	  		if($data[$a]['saldo'] != 0 && $data[$a]['keterangan_level'] >= -1) {
	...
	?>
						<tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                ?>
                                <?php echo $data[$a]['tgl_terakhir_bayar'] != NULL ? '('.tanggal_indo($data[$a]['tgl_terakhir_bayar']).')' : ''; ?>
                            </td>
