...
<table class="kop_surat">
    ...
    <tr>
        <td colspan="10"><center>LAPORAN SIMPANAN DANSOS ANGGOTA ISTIMEWA <?php echo $tanggal ?></center></td>
    </tr>
    <tr>
...
<table border="1" style="width:100%; border-collapse: collapse;">
    ...
    <tr>
        <td colspan="8" style="text-align: center;"><strong>PENCARIAN</strong></td>
        <td style="text-align: right;"><strong><?php echo number_format($pencairan,0,",",".") ?></strong></td>
    </tr>
    <?php
        $selisih_akhir = $selisih - $pencairan;
    ?>
    <tr>
        <td colspan="8" style="text-align: center;"><strong>SELISIH</strong></td>
        <td style="text-align: right;"><strong><?php echo number_format($selisih_akhir,0,",",".") ?></strong></td>
    </tr>
</table>