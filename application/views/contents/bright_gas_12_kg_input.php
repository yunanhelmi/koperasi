      ...
      <div class="row">
	    <div class="col-md-12">
          ...
          <div class="box box-success">
			<div class="box-body">
              <a class="btn btn-success" href="<?php echo base_url(''); ?>index.php/bg12con/download_template">
		...
		<div class="col-md-12">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Import Data Target Sales Bright Gas 12 Kg</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start for target sales-->
            <form action="<?php echo base_url();?>index.php/bg12con/import_target" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Import Data Realisasi Sales Bright Gas 12 Kg</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start for realisasi sales-->
            <form action="<?php echo base_url();?>index.php/bg12con/import_realisasi" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputFile">File input</label>
                  <input required="required" type="file" accept=".xlsx, .xls" name="file">
