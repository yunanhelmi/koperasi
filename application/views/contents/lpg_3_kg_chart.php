...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-free-code-camp"></i> LPG 3 Kg</li>
    ...
    <section class="content">
      <div class="row">
	    <div class="col-md-3 pull-left">
          ...
          <div class="box box-info">
			<form action="<?php echo base_url();?>index.php/lpg3con/chart" method="post" enctype="multipart/form-data" role="form">
			<div class="box-body">
	  ...
	  <div class="row">
		<div class="col-md-12">
		  ...
		  <div class="box-header" style="text-align:center" >
              <h2 class="box-title">Target Sales LPG 3 Kg Tahun <?php echo $thn_chart?></h2>
            </div>
			<div class="box-body">
			...
			<div class="box-footer">
              <form action="<?php echo base_url();?>index.php/lpg3con/export_target" method="post" enctype="multipart/form-data" role="form">
	  ...
	  <div class="row">
		<div class="col-md-12">
          ...
          <div class="box box-warning">
		  <div class="box-header" style="text-align:center" >
              <h2 class="box-title">Realisasi Sales LPG 3 Kg Tahun <?php echo $thn_chart?></h2>
            </div>
			<div class="box-body">
			...
			<div class="box-footer">
              <form action="<?php echo base_url();?>index.php/lpg3con/export_realisasi" method="post" enctype="multipart/form-data" role="form">
				<div class="col-md-2 pull-right">
