  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/penerimaansuratcon/edit_penerimaan_surat"><i class="fa fa-table"></i>Edit Draft Penerimaan Surat</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
       <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            <legend style="text-align:center;">EDIT DRAFT PENERIMAAN SURAT</legend>
            <form action="<?php echo base_url();?>index.php/penerimaansuratcon/update_penerimaan_surat" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                <div class="form-group col-xs-6">
                  ...
                  <div class="input-group date">
                    ...
                    <?php $date = strtotime($data->tanggal);?>
                ...
                <div class="form-group col-xs-6">
                  ...
                  <input type="text" class="form-control" id="nama_petugas_lapangan" name="nama_petugas_lapangan" value="<?php echo $data->nama_petugas_lapangan ?>" placeholder="Petugas Lapangan">
                  <input type="hidden" class="form-control" id="id_petugas_lapangan" name="id_petugas_lapangan" value="<?php echo $data->id_petugas_lapangan ?>">
