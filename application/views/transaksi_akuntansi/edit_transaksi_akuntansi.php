  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/transaksiakuntansicon/edit_transaksi_akuntansi"><i class="fa fa-table"></i>Edit Transaksi</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
       <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            ...
            <form action="<?php echo base_url();?>index.php/transaksiakuntansicon/update_transaksi_akuntansi" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                ...
                <div class="form-group col-xs-6">
                  ...
                  <input type="text" class="form-control" id="kode_akun" name="kode_akun" placeholder="Kode Akun" value="<?php echo $transaksi_akuntansi->kode_akun?>">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Nama Akun</label>
                  <input type="text" class="form-control" id="nama_akun" name="nama_akun" placeholder="Kode Akun" value="<?php echo $transaksi_akuntansi->nama_akun?>">
                </div>
                <div class="form-group col-xs-6">
                ...
                <div class="form-group col-xs-6">
                  ...
                  <div class="input-group margin-bottom-sm">
                    ...
                    <input type="text" class="form-control" id="debet" name="debet" placeholder="0" value="<?php echo $transaksi_akuntansi->debet?>">
                  </div>
                ...
                <div class="form-group col-xs-6">
                  ...
                  <div class="input-group margin-bottom-sm">
                    <span class="input-group-addon">Rp</span>
                    <input type="text" class="form-control" id="kredit" name="kredit" placeholder="0" value="<?php echo $transaksi_akuntansi->kredit?>">
                  </div>
