  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/mappingkodeakuncon/create_mapping_kode_akun"><i class="fa fa-table"></i>Mapping Kode Akun Baru</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
       <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
            <legend style="text-align:center;">MAPPING KODE AKUN BARU</legend>
            <form action="<?php echo base_url();?>index.php/mappingkodeakuncon/insert_mapping_kode_akun" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Nama Transaksi</label>
                  <input type="text" class="form-control" id="nama_transaksi" name="nama_transaksi" placeholder="Nama Transaksi">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Debet</label>
                  <input type="text" class="form-control" id="kode_debet" name="kode_debet" placeholder="Kode Debet">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputPassword1">Kode Kredit</label>
                  <input type="textarea" class="form-control" id="kode_kredit" name="kode_kredit" placeholder="Kode Kredit">
                </div>
              </div>
              <!-- /.box-body -->
