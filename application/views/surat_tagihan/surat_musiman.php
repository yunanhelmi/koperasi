...
<div id="halaman">
    ...
    <p class="body_content">
        ...
        pada koperasi kami tanggal <strong><?php echo $tanggal_pinjaman ?></strong> sampai bulan ini telah berlangsung <?php echo $lama_jatuh_tempo ?> dengan keterlambatan selama <?php echo $lama_pinjam_bulan_hari ?> dari jatuh tempo <?php echo $tgl_jatuh_tempo ?>, dengan rincian sebagai berikut:
    </p>
