...
<div id="halaman">
    ...
    <p class="body_content">
        ...
        pada koperasi kami tanggal <strong><?php echo $tanggal_pinjaman ?></strong> sampai bulan ini telah melampaui dari jatuh tempo angsuran tanggal <strong><?php echo $tgl_jatuh_tempo ?></strong> selama <?php echo $lama_jatuh_tempo?>, dengan rincian sebagai berikut:<br/>
    </p>
