...
<table class="kop_surat">
    ...
    <tr>
        <td colspan="18"><center>DAFTAR SURAT TAGIHAN <?php echo $tanggal ?></center></td>
    </tr>
    <tr>
...
<table border="1" style="width:100%; border-collapse: collapse;">
	...
	<?php
	  	...
	  	for($a = 0; $a < sizeof($data); $a++) {
            if($data[$a]['jenis_pinjaman'] == 'Angsuran') {
                $tanggungan_jasa = ($data[$a]['jasa_pinjaman'] * $data[$a]['jumlah_angsuran']) - $data[$a]['total_jasa_detail'];
            } else {
