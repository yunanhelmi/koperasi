...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li> <i class="fa fa-book"></i> Monitoring Piutang</li>
        <li class="active"><a href="<?php echo base_url(); ?>index.php/monitoringpiutangcon/index"><i class="fa fa-exclamation-triangle"></i> Monitoring Piutang</a></li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-md-12 pull-left">
    			<div class="box box-danger">
    				<legend style="text-align:center;">MONITORING PIUTANG</legend>
    				<form action="<?php echo base_url();?>index.php/monitoringpiutangcon/html" method="post" enctype="multipart/form-data" role="form" target="_blank">
						<div class="box-body">
