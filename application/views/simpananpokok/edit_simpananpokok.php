...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>index.php/nasabahcon"><i class="fa fa-users"></i> Simpanan Pokok</a></li>
      ...
      <div class="row">
	     <div class="col-md-12 pull-left">
          ...
          <div class="box box-danger">
  		      <legend style="text-align:center;">EDIT SIMPANAN POKOK</legend>
            <form action="<?php echo base_url();?>index.php/simpananpokokcon/update_simpananpokok" method="post" enctype="multipart/form-data" role="form">
              <div class="box-body">
                <div class="form-group col-xs-6">
                  ...
                  <select id="id_nasabah" name="id_nasabah" class="form-control select2" style="width: 100%;">
                    ...
                    ?>
                        <option value='<?php echo $nasabah[$i]['id'];?>' <?php echo $simpananpokok->id_nasabah == $nasabah[$i]['id'] ? 'selected' : ''; ?> ><?php echo $nasabah[$i]['nama'].' || '.$nasabah[$i]['nik']?></option>
                     <?php 
                      }
                    ?>
                  </select>
                  <!--<input type="text" class="form-control" id="nama_nasabah" name="nama_nasabah" placeholder="Nama Nasabah">-->
                  <input type="hidden" class="form-control" id="nama_nasabah" name="nama_nasabah" value="<?php echo $simpananpokok->nama_nasabah?>">
                ...
                <div class="form-group col-xs-6">
                  ...
                  <div class="input-group margin-bottom-sm">
                    ...
                    <input type="text" class="form-control" value="<?php echo $simpananpokok->jumlah?>" id="jumlah" name="jumlah" placeholder="Jumlah">
                  </div>
